...
app = Flask(__name__)
app.secret_key='bhg3580qmvh4380q4vmhuamht48'
...
def order():
    ...
    menu = fetchMenu(con)
    con.close()
    return render_template('order.html', disclaimer='may contain traces of nuts', burgers=menu['burgers'], drinks=menu['drinks'], sides=menu['sides'])
...
def confirm():
    ...
    con = sqlite3.connect(MENUDB)
    cur = con.execute(
      'INSERT INTO orders(name, adress, items) VALUES(?, ?, ?)',
